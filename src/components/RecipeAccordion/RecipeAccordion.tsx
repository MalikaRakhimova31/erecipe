        ...
        <AccordionItem>
          <AccordionButton>
            <Text
              ...
              textAlign="left"
            >
              Назначение #{isAppended ? index + 2 : "1"}
            </Text>
            <AccordionIcon />
          </AccordionButton>
          <AccordionPanel>
            <Box mb="36px">
              <Box mb="16px">
                <Text color="secondary.main" fontWeight={500} fontSize="16px">
                  О препарате
                </Text>
              </Box>
              <Grid templateRows="repeat(4, 1fr)" gap="16px">
                <GridItem w="100%">
                  <CSelect
                    control={control}
                    name={
                      isAppended ? `items[${index}].recipeType` : `recipeType`
                    }
                    options={options}
                    title="Тип рецепта"
